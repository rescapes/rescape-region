...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='location',
            name='data',
            field=jsonfield.fields.JSONField(default=rescape_region.model_helpers.region_data_default),
        ),
        migrations.AlterField(
            model_name='location',
            name='geojson',
            field=jsonfield.fields.JSONField(default=rescape_region.model_helpers.feature_collection_default),
        ),
        migrations.AlterField(
            model_name='project',
            name='data',
            field=jsonfield.fields.JSONField(default=rescape_region.model_helpers.project_data_default),
        ),
        migrations.AlterField(
            model_name='project',
            name='geojson',
